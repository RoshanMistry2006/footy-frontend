...
class _DebateRequestsPageState extends State<DebateRequestsPage> {
  ...
  Future<void> _respond(String id, String action) async {
    // ✅ Dismiss keyboard before showing SnackBars (iOS UX fix)
    ...
    return Scaffold(
      ...
      body: _loading
          ...
          : _error != null
              ...
              : _requests.isEmpty
                  ? _buildEmptyState()
                  : SafeArea( // ✅ ensures pull-to-refresh appears correctly on iPhone
                              ...
                              child: ListTile(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    if (r['commentText'] != null && r['commentText'].toString().isNotEmpty)
                                      Padding(
  ...
  Widget _buildStatusWidget(Map<String, dynamic> r, String status, Color glowColor) {
    if (status == 'pending') {
      return Row(
      ...
      if (r['expiresAt'] != null) {
        ...
        expiryText = remaining.isNegative ? 'Expired' : 'Expires in ${remaining.inHours}h';
      }
